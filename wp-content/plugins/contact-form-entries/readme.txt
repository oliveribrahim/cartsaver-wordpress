...
= 1.4.8 =
* fixed "PHP Object Injection via 'download_csv'" issue.

= 1.4.7 =
* fixed "serialized option fields" issue.

= 1.4.6 =
* fixed "download csv file without login" issue.

= 1.4.5 =
* fixed "fatal error when viewing entry" issue.

= 1.4.4 =
* fixed "PHP Object Injection Vulnerability" issue.

= 1.4.3 =
* fixed "json issue on entries view page".
